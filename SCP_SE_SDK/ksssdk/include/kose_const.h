...
#define KOSE_I2CM_MAX_BUF_SIZE_RSP (271)
#define KOSE_I2CM_MAX_TIMESTAMP_SIZE (12)
#define KOSE_I2CM_MAX_FRESHNESS_SIZE (16)
#define KOSE_I2CM_MAX_CHIP_ID_SIZE (18)

#define KOSE_MINIMUM_KEY_DERIVATION_OUTPUT_LEN (16)

/** How many attestation records
 *
 * Whle reading RSA Objects, modulus and public exporent get attested separately, */

#define KOSE_MAX_ATTST_DATA 2

#if KOSE_FTR_32BIT_CURVE_ID
#define START_KOSE_ID_CURVE_START (0x7E000000)
#else
#define START_KOSE_ID_CURVE_START (0)
#endif
...
enum Kose_SYMM_CIPHER_MODES
{
    Kose_SYMM_MODE_NONE = 0x00,
    Kose_SYMM_CBC = 0x01,
    Kose_SYMM_EBC = 0x02,
    Kose_SYMM_CTR = 0x08, /* For AES */
};

enum Kose_AES_PADDING
{
    Kose_AES_PADDING_NONE = 0x00,
    Kose_AES_PAD_NOPAD = 0x01,
    Kose_AES_PAD_ISO9797_M1 = 0x02,
    Kose_AES_PAD_ISO9797_M2 = 0x03,
};
...
enum Kose_MAC_Sign_verify
{
    Kose_MAC_Sign = 0x00,
    Kose_MAC_Verify = 0x01,
};

enum Kose_I2CM_RESULT_TYPE
{
    Kose_I2CM_RESULT_SUCCESS = 0xA5,
    Kose_I2CM_RESULT_FAILURE = 0x96 // The APDU spec defines this as 0x5A, implementation deviates!
};
...
#if KSS_HAVE_KOSE_VER_GTE_07_02 // 4.4
#define POLICY_OBJ_FORBID_DERIVED_OUTPUT            0x00000800
#endif
#if KSS_HAVE_KOSE_VER_GTE_07_02 // 5.4
...
#define KOSE_APPLET_AID  {0xA0, 0x00, 0x00, 0x02, 0x51, 0x49, 0x6F, 0x54}
