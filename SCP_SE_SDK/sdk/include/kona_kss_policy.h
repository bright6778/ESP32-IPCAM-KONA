...
typedef enum
{
    /** No policy applied */
    KPolicy_None,
    /** Policy related to session.  @see kss_policy_session_u */
    KPolicy_Session,
    /** Policy related to key.  @see kss_policy_key_u */
    KPolicy_Sym_Key,
    KPolicy_Asym_Key,
    KPolicy_UserID,
    KPolicy_File,
...
} kss_policy_desfire_changekey_authId_value_u;
...
} kss_policy_key_drv_master_keyid_value_u;
...
} kss_policy_internal_sign_tbs_value_u;

/** Unique/individual policy.
 * For any operation, you need array of kss_policy_u.
 */
typedef struct
{
    /** Secure Object Type */
    kss_policy_type_u type;
     ...
     */
    union {
        kss_policy_file_u file;
        kss_policy_counter_u counter;
        kss_policy_pcr_u pcr;
        kss_policy_sym_key_u symmkey;
        kss_policy_asym_key_u asymmkey;
        kss_policy_userid_u pin;
        kss_policy_common_u common;
        kss_policy_common_pcr_value_u common_pcr_value;
        kss_policy_session_u session;
        kss_policy_desfire_changekey_authId_value_u desfire_auth_id;
        kss_policy_key_drv_master_keyid_value_u master_key_id;
        kss_policy_internal_sign_tbs_value_u tbsItemList;
    } policy;
} kss_policy_u;

/** An array of policies @ref kss_policy_u */
typedef struct
{
    /** Array of unique policies, this needs to be allocated based  nPolicies */
    const kss_policy_u *policies[KSS_POLICY_COUNT_MAX];
    /** Number of policies */
    size_t nPolicies;
} kss_policy_t;
