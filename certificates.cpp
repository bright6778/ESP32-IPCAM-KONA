...
// AWS certificate
const char* aws_rootCACertificate = R"~(
  -----BEGIN CERTIFICATE-----
  MIIDKzCCAhOgAwIBAgIQJOOyowYpLEiLnhpjD0HR5DANBgkqhkiG9w0BAQsFADAg
  MR4wHAYDVQQDExVSZWJleCBUaW55IFdlYiBTZXJ2ZXIwHhcNMjMxMTI1MTQ1NzU4
  WhcNMzMxMTI1MTQ1NzU4WjAgMR4wHAYDVQQDExVSZWJleCBUaW55IFdlYiBTZXJ2
  ...
  // Paste in device certificate
const char* deviceCACertificate = R"~(
  -----BEGIN CERTIFICATE-----
  
  -----END CERTIFICATE-----
  )~";

  // Paste in se private key
const char* se_prvtkey_pem = R"~(
  -----BEGIN PRIVATE KEY-----
  MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQg97AjENBiJnmSMdbf
  cvQz4D8Gi1NdTWsb1d5ocd3dZYO+hRANCAAQJ/jn5aY6cK93cK1IZG9Mfr2GQHZKR
  gxscRiq9XvQLdTxLrxW0K+3kXIj1bbKPlG98dyc2V0QdDkVxOfn/BhlT
  -----END PRIVATE KEY-----
  )~";
#endif
